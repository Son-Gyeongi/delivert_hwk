package com.sparta.delivery_hwk;
//1. 음식점 등록 및 조회 테스트 코드
...
class RestaurantIntegrationTest {
    ...
    /**
     * Restautant, RestautantDto, RestautantController, RestautantService, RestautantRepository
     */
    @Nested //이건 뭐지?
    @DisplayName("음식점 3개 등록 및 조회") //이건 뭐지?
